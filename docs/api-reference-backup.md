...
<div class="function-card">
  ...
  <ul class="param-list">
    ...
    <li><span class="param-icon">🔸</span> <code>Command</code>: Command string to execute</li>
    <li><span class="param-icon">🔸</span> <code>ScriptBlock</code>: Alternative to Command - code block to execute</li>
    <li><span class="param-icon">🔸</span> <code>MaxParallel</code>: Maximum concurrent executions</li>
    <li><span class="param-icon">🔸</span> <code>TimeoutSeconds</code>: Command timeout in seconds</li>
    <li><span class="param-icon">🔸</span> <code>DryRun</code>: Validate without executing</li>
    <li><span class="param-icon">🔸</span> <code>PromptUser</code>: Show interactive output</li>
